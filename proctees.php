...
if(isset($_GET['a'])){
      ...
      $query = "SELECT * from sem_record WHERE email='".$_GET['a']."' AND sent='y' AND signed='n'";
  ...
  while ($row = mysqli_fetch_assoc($results)) {
     ...
     echo "</table>";
    echo "
    <a style='margin-right: 30px;' class='button is-warning is-pulled-right' href='proctees.php?s=".$row['id']."&email=".$_GET['a']."'><i class='fas fa-pen' style='margin-right: 5px; font-size: 85%;'></i>Sign</a><br/>";
    echo "<hr/>";
